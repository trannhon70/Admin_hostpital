...
<div class="headers">
	...
	<div class="headers_oprate"><form name="topform" method="GET">ģ��������<input name="key" value="<?php echo $_GET["key"]; ?>" class="input" size="8">&nbsp;<input type="submit" class="search" value="����" style="font-weight:bold" title="�������">&nbsp;<input type="button" value="����" onclick="location='?'" class="search" title="�˳�������ѯ">&nbsp;&nbsp;<input type="button" value="����" onclick="history.back()" class="button" title="������һҳ"></form></div>
</div>
<!-- ͷ�� end -->
