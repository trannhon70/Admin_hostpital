...
<div id="m_info">�����ˣ�<?php echo $line["u_realname"]; ?>����ʱ�䣺<?php echo date("Y-m-d H:i", $line["addtime"]); ?></div>
<div id="m_content"><?php echo text_show($line["content"]); ?></div>

<div style="padding:20px 0 5px 0; text-align:center; ">
	<input type="submit" class="submit" onclick="update_read()" value="�Ķ����">
</div>
