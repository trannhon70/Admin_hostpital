...
if ($op = $_GET["op"]) {
	switch ($op) {
		...
		case "insert":
			!check_power("i", $pinfo, $pagepower) && msg_box("û������Ȩ��...", "back", 1);
		...
		case "setshow":
			!check_power("h", $pinfo, $pagepower) && msg_box("û�п�ͨ�͹ر�Ȩ��...", "back", 1);
...
$aTdFormat = array(
	...
	1 => array("title" => "ҽ�����", "width" => "30%", "align" => "left", "sort" => "binary name", "defaultorder" => 1),
	2 => array("title" => "����", "width" => "30%", "align" => "left", "sort" => "binary name", "defaultorder" => 1),
...
<body>
	<!-- ͷ�� begin -->
	<div class="headers">
		<div class="headers_title"><span class="tips"><?= $hospital_id_name[$user_hospital_id] ?> - ҽ���б�</span></div>
    ...
    <table width="100%" align="center" class="list">
        <!-- ��ͷ���� begin -->
        <tr>
            <?php foreach ($aTdFormat as $tdid => $tdinfo) {
        ...
        if (count($data) > 0) {
            foreach ($data as $line) {
                ...
                // Xây dựng các nút điều khiển chỉ nếu người dùng có quyền sửa hoặc xóa
                $op = array();
                if (check_power("edit")) {
