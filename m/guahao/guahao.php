    ...
    <table width="100%" align="center" class="list">
        ...
        ?>
                ...
                <?php
                    ...
                    // Xử lý các dòng dữ liệu khác
                    $op = array();
                    if (check_power("v", $pinfo, $pagepower)) {
                        $op[] = "<a href='" . $pinfo["viewpage"] . "?id=$id' class='op'><img src='/res/img/b_detail.gif' align='absmiddle' title='Xem' alt=''></a>";
                    }
                    if (check_power("edit")) {
                        $op[] = "<a href='" . $pinfo["editpage"] . "?id=$id&go=back' class='op'>Sửa</a>";
                    }
            ...
            ?>
            <tr>
                <td colspan="<?php echo count($aTdFormat); ?>" align="center" class="nodata">(Không có dữ liệu)</td>
            </tr>
        <?php } ?>
    </table>
</form>
